...
public class OpenAccountController {
    ...
    public ResponseEntity<OpenAccountResponse> openAccount(@Valid @RequestBody OpenAccountCommand command) {
        ...
        try {
            ...
            var errorMessage = "Error while processing request to open a new bank account for id " + id;
            System.out.println(e.toString());
            return new ResponseEntity<>(new OpenAccountResponse(id, errorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
        }
