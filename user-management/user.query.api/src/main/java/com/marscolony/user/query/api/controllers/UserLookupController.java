package com.marscolony.user.query.api.controllers;
...
public class UserLookupController {
    ...
    @GetMapping(path = "/")
    @PreAuthorize("hasAuthority('READ_PRVILEGE')")
    public ResponseEntity<UserLookupResponse> getAllUsers() {
        ...
        try {
            ...
            var errorMessage = "Failed to complete get all users request";
    ...
    public ResponseEntity<UserLookupResponse> getUserById(@PathVariable(value = "id") String id) {
        ...
        try {
            ...
            var errorMessage = "Failed to complete get user by id request";
            System.out.println(e.toString());
            return new ResponseEntity<>(new UserLookupResponse(errorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<UserLookupResponse> searchUserByFilter(@PathVariable(value = "filter") String filter) {
        ...
        try {
            ...
            var errorMessage = "Failed to complete user search request";
            System.out.println(e.toString());
            return new ResponseEntity<>(new UserLookupResponse(errorMessage), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
